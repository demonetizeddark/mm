...
API.FrameVideoControls = function (video) {
    ...
    newNode.html(
        ...
        "<li id=\"" + FrameVideoControls.idPrefix + "play\" class=\"play\"><a href='javascript:void(0);'>Play</a></li>" +
...
API.CVideo = function () {
    ...
    */
    ...
    this.writePlayer = function () {
        ...
        var serverAddressAndName = Player.currentMediaServer + "," + Player.currentMediaServerName;
        ...
        var folderArray = API.E2020.addresses.videoFolder.split(",");
